...
$lang = array(
    ...
    //Error messages
    "installerror" => "<b>Une erreur est survenue lors de l'installation de l'application. Veuillez vérifier votre configuration et que vous ayez lancé correctement : www.{votre-site}.com/bans/admin/install.php</b>",
    ...
    "appealacceptedbold" => "La demande a été acceptée!",
    ...
    "playerblocked" => "Le joueur a été bloqué et ne peut plus contester de bannissement à présent",
    ...
    "installcommunityid" => "Steam Community ID: (Exemple: 76561198030856249)",
    ...
    //Ban Appeal
    "makeappeal" => "Faire une demande de débannissement",
    ...
    "banappealmessage" => "Demande de débannissement",
